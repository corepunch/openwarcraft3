...
| WC3 game save/load format, entity pointer fixups, `F_CFUNCTION` C callbacks, and `SAVEFIELD` synchronization | [docs/games/warcraft-3/save-load.md](docs/games/warcraft-3/save-load.md) |
