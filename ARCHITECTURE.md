...
| `svc_configstring` | `SHORT index`, string or fixed binary slot | Media registry; `CS_LOADINGSCREEN1` through `CS_LOADINGSCREEN_LAST` store a 2-KiB compressed loading frame tree. |
