...
The StarCraft II renderer (`games/starcraft2/renderer/m3/r_m3_load.c`) reads these arrays and builds a VBO with the following per-vertex layout:
...
| Source | Purpose |
|--------|---------|
| `games/starcraft2/renderer/m3/r_m3.h` | All M3 struct definitions |
| `games/starcraft2/renderer/m3/r_m3_load.c` | Reference-table reader, model loader, and GLSL shader |
