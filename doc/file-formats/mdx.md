...
Not all chunks are present in every model. The loader (`renderer/mdx/r_mdx_load.c`) dispatches on each FourCC tag.
...
| Source | Purpose |
|--------|---------|
| `renderer/mdx/r_mdx.h` | All MDX struct definitions |
| `renderer/mdx/r_mdx_load.c` | Chunk parser and model loader |
| `renderer/mdx/r_mdx_render.c` | Per-frame skinning and draw calls |
| `renderer/mdx/r_mdx_interpolation.c` | Keyframe track evaluation |
