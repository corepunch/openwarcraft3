...
Save format version 13 moves the group registry out of the inline `level_fields` schema and writes it explicitly. Version 12 and older saves are intentionally rejected. Runtime creation has no 1024-style handle ceiling; the save reader/writer separately rejects more than 65,536 group ordinals as a corrupt/oversized-save safety bound.
