...
static abilityitem_t abilitylist[] = {
    ...
    { "AAbt", &CAbilityButton },
    { "AAsp", &CAbilitySpell },
    { "AAsm", &CAbilitySimpleSpell },
    { "AAms", &CAbilityModalSpell },
    { "AAat", &CAbilityAutoTargetSpell },
    { "AAcs", &CAbilityClosestTargetSpell },
    { "AHRa", &CAbilityRangerArrow },
    { "APas", &CAbilityPassive },
    { "AAns", &CAbilityNeutralSpell },
    { "Amor", &CAbilityMorph },
    { "ABon", &CBonusBase },
    { "APbo", &CAbilityPersistentBonus },
    { "AREB", &CAbilityRegenBase },
    { "aura", &CAbilityAura },
    { "ABbs", &CAbilityBaseBuild },
    { "ABld", &CAbilityBuild },
    { "ABqu", &CAbilityBuildQueue },
    { "ABnP", &CAbilityBuildInProgress },
    { "AInP", &CAbilityInProgress },
    { "AUnP", &CAbilityUpgradeInProgress },
    { "ASnP", &CAbilitySacrificeInProgress },
    { "ATrn", &CAbilityTrain },
    { "ARes", &CAbilityResearch },
    { "ASbs", &CAbilityBaseSell },
    { "Asei", &CAbilitySellItem },
    { "Asel", &CAbilitySellUnit },
    { "Amai", &CAbilityMakeItem },
    { "Aque", &CAbilityQueue },
    { "Aupg", &CAbilityUpgrade },
    { "Arem", &CAbilityRegenMana },
    { "AEsd", &CAbilityStarfallDrain },
    { "AEtr", &CAbilityTranquilityRegen },
    { "AIDB", &CAbilityDamageBonusBase },
    { "AIDE", &CAbilityDamageBonusBaseEx },
    { "AIca", &CAbilityItemCureAoe },
    { "AIfc", &CAbilityItemFlyingCarpet },
    { "AImn", &CAbilityMaxManaMod },
    { "AIpi", &CAbilityItemPermInvis },
    { "AIte", &CAbilityItemTeleport },
    { "ANgl", &CAbilityNeutralG2L },
    { "ANlg", &CAbilityNeutralL2G },
    { "ANmd", &CAbilityMonsoonDrain },
    { "ANrl", &CAbilityNeutralRegenLife },
    { "ANrm", &CAbilityNeutralRegenMana },
    { "ANsp", &CAbilityNeutralSpies },
    { "Aasp", &CAbilityAuraSpell },
    { "Abar", &CAbilityBarkskin },
    { "Ablr", &CAbilityBlightRegen },
    { "Abou", &CAbilityBounce },
    { "Acal", &CAbilityCallToArms },
    { "Achb", &CAbilityChaosBase },
    { "Acou", &CAbilityCouple },
    { "Acrg", &CAbilityCargo },
    { "Admg", &CAbilityNotifyDamage },
    { "Adta", &CAbilityDetectAoe },
    { "Agmb", &CAbilityGoldMineBase },
    { "Agyc", &CAbilityGraveyardCorpse },
    { "Ahrb", &CAbilityHarvestBase },
    { "Ahrr", &CAbilityHarvestReturn },
    { "Alea", &CAbilityLeash },
    { "Amou", &CAbilityMount },
    { "Anei", &CAbilityNeutralInteract },
    { "Anit", &CAbilityNightVision },
    { "Apgm", &CAbilityPossessedGoldMine },
    { "Arsc", &CAbilityRescuable },
    { "Atpi", &CAbilityTankPilot },
    { "Atrg", &CAbilityTarget },
