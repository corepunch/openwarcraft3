...
static abilityitem_t abilitylist[] = {
    ...
    /* CampaignAbilityStrings.txt entries. Keep campaign rawcodes explicit even
     * when their names resemble standard abilities; their SLK rows are distinct. */
    // TODO: campaign descriptor needs a code-specific spell_info_t.
    { "Aamk", &a_attribute_bonus },  // Attribute Bonus
    { "ACtn", &a_spawn_tentacle },  // Spawn Tentacle
    { "ANav", &a_avatar_campaign },  // Avatar (Garithos campaign)
    { "ANsh", &a_shockwave_campaign },  // Shockwave (campaign)
    { "AOw2", &a_war_stomp_campaign },  // War Stomp (Cairne campaign)
    // TODO: campaign descriptor needs a code-specific summon spell.
    { "ACs7", &a_feral_spirit_campaign },  // Feral Spirit (Akama campaign)
    { "ACs8", &a_spirit_beast },  // Spirit Beast (Akama campaign)
    { "ANr2", &a_reincarnation_campaign },  // Reincarnation (generic campaign)
    { "Afbb", &a_feedback },  // Feedback
    { "Andm", &a_abolish_magic },  // Abolish Magic
    { "Asb1", &a_submerge_myrmidon },  // Submerge (Myrmidon)
    { "Asb2", &a_submerge_royal_guard },  // Submerge (Royal Guard)
    { "Asb3", &a_submerge_snap_dragon },  // Submerge (Snap Dragon)
    { "ANha", &a_harvest },  // Harvest (Naga campaign; shared command contract)
    { "ANen", &a_ensnare },  // Ensnare (Naga campaign)
    { "ACfu", &a_frost_armor_campaign },  // Frost Armor (Naga campaign)
    { "ANpa", &a_parasite },  // Parasite
    { "Acny", &a_cyclone_campaign },  // Cyclone (Naga campaign)
    { "Ahnl", &a_summoning_ritual },  // Summoning Ritual
    // TODO: campaign descriptor needs a code-specific summon spell.
    { "Arsq", &a_summon_quilbeast_campaign },  // Summon Quilbeast (Rexxar campaign)
    { "Arsg", &a_summon_misha },  // Summon Misha (Rexxar campaign)
    { "Arsp", &a_stampede_campaign },  // Stampede (Rexxar campaign)
    { "ANbr", &a_battle_roar },  // Battle Roar
    { "ANsb", &a_storm_bolt_campaign },  // Storm Bolt
    { "ANcf", &a_breath_of_fire_campaign },  // Breath of Fire (Chen campaign)
    { "Acdh", &a_drunken_haze_campaign },  // Drunken Haze (Chen campaign)
    { "Acef", &a_storm_earth_fire },  // Storm, Earth, And Fire (Chen campaign)
    { "ANhw", &a_healing_wave_campaign },  // Healing Wave (Rokhan campaign)
    { "ANhx", &a_hex_campaign },  // Hex (Rokhan campaign)
    { "Arsw", &a_serpent_ward },  // Serpent Ward (Rokhan campaign)
    { "AOs2", &a_shockwave_cairne },  // Shockwave (Cairne campaign)
    { "AOr2", &a_endurance_aura_campaign },  // Endurance Aura (Cairne campaign)
    { "AOr3", &a_reincarnation_cairne },  // Reincarnation (Cairne campaign)
    { "AOls", &a_voodoo_spirits },  // Voodoo Spirits (Rokhan campaign)
...
/* Generated by ability_map from Game.dll RTTI + AbilityData.slk */
    ...
    // TODO: { "ANbr", &a_bash },  // Battle Roar — CAbilityBash [HERO] creeps; CampaignAbilityStrings.txt: nearby friendly units gain attack damage for DataA/Dur.
