...
extern ability_t a_poison_arrows;
extern ability_t a_burrow_detection, a_revive_hero, a_revive_hero_instant, a_detector, a_hero, a_alarm;
extern ability_t a_on_fire;
extern ability_t a_locust, a_turret;
...
extern ability_t a_aerial_shackles, a_feedback_human, a_control_magic, a_flak_cannons, a_fragmentation_shards, a_barrage;
extern ability_t a_magic_defense, a_sphere, a_spell_steal, a_cloud, a_phoenix_morphing, a_flying_machine_bombs;
extern ability_t a_storm_hammers, a_true_sight_flying_machine, a_defend, a_flare, a_magic_sentry, a_inner_fire;
extern ability_t a_dispel_magic, a_heal, a_slow, a_invisibility, a_polymorph, a_avatar;
