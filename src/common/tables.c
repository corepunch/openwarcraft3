...
struct SheetLayout UnitBalances[] = {
    ...
    { "comment", ST_STRING, FOFS(UnitBalance, comment) },
    { "level", ST_INT, FOFS(UnitBalance, level) },
    { "flag", ST_STRING, FOFS(UnitBalance, flag) },
    ...
    { "abilTest", ST_INT, FOFS(UnitBalance, abilTest) },
