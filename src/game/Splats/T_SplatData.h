#ifndef __T_SplatData_h__
#define __T_SplatData_h__
...
typedef struct T_SplatData T_SPLATDATA;
typedef struct T_SplatData *LPT_SPLATDATA;
typedef struct T_SplatData const *LPCT_SPLATDATA;
