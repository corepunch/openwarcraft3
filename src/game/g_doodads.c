...
struct SheetLayout doodad_info[] = {
    { kDoodadInfo_doodID, ST_ID, FOFS(DoodadInfo, doodID) },
    { kDoodadInfo_dir, ST_STRING, FOFS(DoodadInfo, dir) },
    { kDoodadInfo_file, ST_STRING, FOFS(DoodadInfo, file) },
    { kDoodadInfo_pathTex, ST_STRING, FOFS(DoodadInfo, pathTex) },
    { 0 }
};
